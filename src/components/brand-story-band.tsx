...
export function BrandStoryBand() {
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      <div className="grid overflow-hidden rounded-3xl bg-basket-green text-white md:grid-cols-[1fr_1.1fr]">
        ...
        <div className="space-y-3 bg-basket-green-light/10 p-6 sm:p-8">
          {STEPS.map((s) => (
            <div key={s.n} className="rounded-card bg-white/5 p-5">
              <div className="flex items-start gap-4">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-basket-terracotta text-xs font-semibold text-white">
                  {s.n}
                </span>
                <div>
