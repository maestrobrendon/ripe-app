...
export function AnnouncementBar() {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 bg-basket-green px-4 py-2 text-center text-xs font-medium text-white sm:text-sm">
