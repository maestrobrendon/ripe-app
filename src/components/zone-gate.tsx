          ...
          <div className="w-full max-w-md rounded-card bg-surface p-6 shadow-xl">
            {status === "out-of-area" ? (
              <>
                ...
                {saved ? (
                  <p className="mt-4 rounded-lg bg-basket-green-light p-3 text-sm">Thanks. We will be in touch.</p>
                ) : (
                  <div className="mt-4 flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-full bg-basket-green px-4 py-2 text-sm font-medium text-white"
                    >
                      Notify me
                    </button>
                  </div>
                )}
                <button onClick={() => setStatus("idle")} className="mt-4 text-sm text-basket-green underline">
                  Back
                </button>
              </>
            ) : (
              <>
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-full bg-basket-green px-4 py-2.5 text-sm font-medium text-white hover:bg-basket-green-dark disabled:opacity-60"
                >
